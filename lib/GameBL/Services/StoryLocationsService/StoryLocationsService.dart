...
class StoryLocationsService {
  ...
  final List<StoryLocationModel> locations = [
    ...
    StoryLocationModel(id: 5, levels: [19, 20, 21, 22, 23, 24], backgroundFileName: "mountains_night.jpg", title: "Night adventure", coinReward: 500),
    StoryLocationModel(id: 6, levels: [25, 26, 27, 28, 29, 30, 31], backgroundFileName: "beach_with_boat.jpg", title: "Mystery iceland", coinReward: 600),
  ];
